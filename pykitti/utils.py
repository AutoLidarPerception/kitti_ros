...
def get_oxts_packets_and_poses(oxts_path):
    ...
    if os.path.isdir(oxts_path):
        for oxts_file in os.listdir(oxts_path):
            if os.path.isdir(oxts_file):
                continue
            else:
                oxts_files.append(oxts_file)
    oxts_files.sort()
    ...
    for filename in oxts_files:
        with open(oxts_path + "/" + filename, 'r') as f:
            for line in f.readlines():
                line = line.split()
